...
console.log('MegaCoin Service native interface vs. MegaCoin JSON RPC interface');
console.log('----------------------------------------------------------------------');
...
var bitcoind = require('../').services.Bitcoin({
  node: {
    datadir: process.env.HOME + '/.megacoin',
    network: {
      name: 'testnet'
    }
  }
...
bitcoind.start(function(err) {
  ...
  console.log('MegaCoin started');
});

bitcoind.on('ready', function() {

  console.log('MegaCoin ready');
