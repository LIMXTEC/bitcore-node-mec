...
var BASE_PACKAGE = {
  description: 'A full MegaCoin node build with Bitcore',
  repository: 'https://github.com/LIMXTEC/bitcore-node-mec',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-mec': 'LIMXTEC/bitcore-lib-mec',
    'bitcore-node-mec': 'LIMXTEC/bitcore-node-mec'
  }
};
